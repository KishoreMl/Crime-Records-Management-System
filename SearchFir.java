		...
		dateSearch.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e)
			{
					...
					String status="";
						...
						catch(java.lang.NullPointerException ee2)
						{
							dmsg.setVisible(true);
						}
						catch(SQLException e1)
						{
							JOptionPane.showMessageDialog(Searchpan, "Database not connected date"+e1);
						}
		...
		stationSearch.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				else 
				{
					...
					{
						JOptionPane.showMessageDialog(Searchpan, "Database not connected station  "+e1);
					}
					catch(ArrayIndexOutOfBoundsException ee1)
					{
		...
		firIdSearch.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				else
				{
					...
					{
						JOptionPane.showMessageDialog(Searchpan, "Database not connected fir"+e1);
					}
					catch(ArrayIndexOutOfBoundsException ee1)
					{
